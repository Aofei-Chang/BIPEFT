...
from lora.lora import LoRA_T5, weights
from lora.mom_s3delta import MoM_T5
...
def get_args_parser():
    ...
    parser.add_argument("--train_type", "-tt", type=str, default="lora",
                        help="lora: only train lora, mix: train all the PEFT modules;  full: finetune on all, linear: finetune only on linear layer")
    ...
    parser.add_argument('--is_RepAdapter', action='store_true')

    parser.add_argument("--prompt_len", type=int, default=10)
    parser.add_argument("--prompt_layer", type=int, default=11)
    ...
    parser.add_argument('--fix_lora', action='store_true', help='whether use lora NAS')
    parser.add_argument('--use_qkvo', action='store_true', help='whether use lora only on qkvo')
    parser.add_argument('--search_all_lora', action='store_true', help='whether use lora NAS on every possible position')

    parser.add_argument('--fix_adapter', action='store_true', help='whether use adapter NAS')
    ...
    parser.add_argument('--arch_kl_reg', type=float, default=5e-3, metavar='LR',
    ...
    parser.add_argument('--prompt_weight_decay', type=float, default=0.001,
                        help='prompt weight decay (default: 0.001)')
    ...
    parser.add_argument('--load_optim', action='store_true',
                        help='whether to use trained optim')

    parser.add_argument('--progressive_fix', action='store_true',
                        help='whether to use progressive pruning')
    parser.add_argument('--use_sparse', action='store_true', help='whether to use progressive pruning')
    ...
    parser.add_argument('--prune_criterion', type=str, default='tra', choices=['tra', 'val', 'tra_val', 'tra_val_cos1', 'tra_val_cos2'],
                        help='criterion for pruning')
    parser.add_argument('--prune_threshold', type=float, default=0.9,
                        help='stability-based pruning threshold (default: 0.9)')
    parser.add_argument('--no_abs_grad', action='store_true', help='whether using adapter')
    parser.add_argument('--split_train_data', action='store_true', help='whether to split training data')

    parser.add_argument('--last_zeta', type=float, default=0, help='zeta for budget')
    parser.add_argument('--search_adapter', action='store_true', help='whether to use adapter search')
    parser.add_argument('--budget_anneal', action='store_true', help='whether to use budget annealing')
    ...
    parser.add_argument('--search_mom', action='store_true', help='whether to search mom')
